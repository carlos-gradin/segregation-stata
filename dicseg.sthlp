...
{* March 2026}{...}
{hline}
help for {hi:dicseg (Version 2.3)}{right:Carlos Grad{c i'}n (March 2026)}
{hline}
...
(For multigroup cases see {help localseg}; for low-pay segregation see {help lowseg})
...
{p 4 4 2}
Segregation indices (for formulae and details, see {browse "http://webs.uvigo.es/cgradin/Measuring_Segregation_Using_Stata__The_Two_group_Case.pdf": Grad{c i'}n, 2014}):
...
{p 8 8 2}
{cmdab:no:graph} to suppress graphing of segregation curves.
...
{p 8 8 2}
r(D), r(KM), r(GEm2), r(GEm1), r(GE0), r(GE10), r(GE25), r(GE50), r(GE75), r(GE90), r(GE1), r(GE2), r(H), r(CV), r(A10), r(A25), r(A50), r(A75), r(A90), r(A1), r(A2), r(A4), r(M), r(Gini)
...
{p 8 8 2}
 bootstrap r(D) r(KM) r(GE1) r(H) r(M) r(Gini) , reps(10): dseg
...
{p 4 8 2}
Grad{c i'}n, Carlos (2014), {browse "http://webs.uvigo.es/cgradin/Measuring_Segregation_Using_Stata__The_Two_group_Case.pdf": Measuring Segregation using Stata}, Universidade de Vigo.
...
{p 4 13 2}
{help lowseg} if installed; {help localseg} if installed; {help duncan} if installed; {help hutchens} if installed; {help seg} if installed
